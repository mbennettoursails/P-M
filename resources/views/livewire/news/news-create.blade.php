                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                            ...
                            @else
                                <div 
                                    ...
                                    @drop.prevent="isDragging = false; $refs.imageInput.files = $event.dataTransfer.files; $refs.imageInput.dispatchEvent(new Event('change'))"
                                    :class="{ 'border-green-500 bg-green-50 dark:bg-green-900/20': isDragging }"
                                    class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-8 text-center hover:border-gray-400 dark:hover:border-gray-500 transition cursor-pointer"
                                >
                                    <input 
                                        type="file" 
                                    ...
                                    <label for="featuredImage" class="cursor-pointer">
                                        ...
                                        <p class="text-gray-600 dark:text-gray-400">
                                            {{ __('クリックまたはドラッグ＆ドロップで画像をアップロード') }}
                                        </p>
                                        <p class="text-sm text-gray-500 dark:text-gray-500 mt-1">
                                            {{ __('PNG, JPG, GIF (最大5MB)') }}
                                        </p>
                                    </label>
                                </div>
                            @endif
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                            ...
                            <div class="mb-4">
                                <label for="category" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                    {{ __('カテゴリ') }} <span class="text-red-500">*</span>
                                </label>
                                <select 
                                    id="category"
                                    wire:model="category"
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 space-y-3">
                            ...
                            <a 
                                href="{{ route('news.index') }}"
                                wire:navigate
                                class="block w-full px-4 py-3 text-center text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition"
                            >
                                {{ __('キャンセル') }}
                            </a>
                        </div>
